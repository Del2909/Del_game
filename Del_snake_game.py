...
class game():
    def __init__(self,speed, size=1):
        ...
        pg.display.set_caption("Del's Snake Game")
...
class startmenu():
    ...
    def mainloop(self):
        while 1:
            ...
            self.make_text(400, 150, "Del's Snake Game", color = (255,255,255), size = 80, a = True)
            for event in pg.event.get():
                if event.type == pg.QUIT:
                    sys.exit()
            for x in self.blocks:
            ...
            pg.display.update()
    def start(self):
        self.b1 = '(250, 300,300,50),"LETS PLAYY!!", [(0,255,0), (0,150,0)], action = self.start3'
        self.buttons = [self.b1]
    def start3(self):
        self.b1 = '(105, 300,100,50),"Easy", [(0,255,0), (0,150,0)], action = self.e'
        self.b2 = '(239, 300,100,50),"Normal", [(0,255,0), (0,150,0)], self.n'
        self.b3 = '(373, 300,100,50),"Hard", [(0,255,0), (0,150,0)], action = self.h'
